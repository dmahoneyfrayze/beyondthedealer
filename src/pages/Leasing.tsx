...
const Leasing = () => {
  return (
    <div className="min-h-screen flex flex-col">
      <Helmet>
        <title>Vehicle Leasing | Low Payment Car Lease Deals</title>
        <meta
          name="description"
          content="Explore vehicle leasing options. Lower monthly payments, latest models, and flexible terms. Compare leasing vs buying for your situation."
        />
      </Helmet>
      ...
      <main className="flex-grow bg-background">
        <div className="bg-gradient-to-br from-primary to-accent text-primary-foreground py-16">
          <div className="container mx-auto px-4 text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-4">Vehicle Leasing</h1>
