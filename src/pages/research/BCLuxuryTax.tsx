      ...
      <main className="flex-grow bg-background">
        <div className="bg-gradient-to-br from-primary to-accent text-primary-foreground py-16">
          <div className="container mx-auto px-4 text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-4">BC Luxury Tax Guide</h1>
            <p className="text-lg opacity-90 max-w-3xl mx-auto">
              Understanding the federal luxury tax on vehicles in British Columbia
            </p>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="grid lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2 space-y-8">
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-muted-foreground">
                          ...
                          This tax applies to both new vehicles and aircraft, and is separate from GST and PST.
                        </p>
                      </div>
                    </div>
                  </CardContent>
                  ...
                  <Card>
                    <CardContent className="p-6">
                      ...
                      <ul className="space-y-2 text-muted-foreground ml-4">
                        <li>• 10% of the total price (including GST/PST), OR</li>
                  ...
                  <Card>
                    <CardContent className="p-6">
                      ...
                      <ul className="space-y-2 text-muted-foreground">
                        ...
                        <li>• Includes GST and PST in the calculation</li>
              ...
              <section>
                <h2 className="text-3xl font-bold mb-6">BC Tax Breakdown</h2>
                <Card>
                  <CardContent className="p-6">
                    <h3 className="font-semibold text-lg mb-4">For a $120,000 Vehicle:</h3>
                    <div className="space-y-3">
                      ...
                      <div className="flex justify-between items-center p-3 bg-primary/10 rounded border-2 border-primary">
                        ...
                        <span className="font-bold text-lg">$138,400</span>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card className="bg-secondary">
                  <CardContent className="p-6">
                    ...
                    <ul className="space-y-2 text-sm text-muted-foreground">
                      <li>• The luxury tax is calculated on the total price including GST and PST</li>
